...
>
	<div class=" flex justify-center mt-[0px]">
		<svg
			...
			viewBox="0 0 24 24"
			stroke-width="1.2"
			stroke="oklch(61.364% 0.23778 10.315 / 0.895)"
			fill="none"
		...
		<h3 class="font-manrope flex items-center text-xl font-semibold text-rose-600">airbnb</h3>
	</div>
	...
	>
		{#each navItems as navItem}
			<li
				class="items-bottom group relative my-auto inline-flex h-full p-4 text-stone-900 hover:scale-105 hover:text-stone-900"
			>
				<a href={navItem.url}>{navItem.label}</a>
				<div
					class="absolute h-1 w-auto bg-red-500 opacity-0 duration-150 ease-out group-hover:opacity-100"
				/>
			</li>
		{/each}
	</ul>

	<button class=" flex ml-auto focus:outline-none md:hidden">
		<svg
			xmlns="http://www.w3.org/2000/svg"
	...
	<img
		...
		viewBox="0 0 24 24"
		stroke="currentColor"
		class="hidden rounded-full md:flex border-2 m-0 p-0"
		alt=""
	/>
</nav>
