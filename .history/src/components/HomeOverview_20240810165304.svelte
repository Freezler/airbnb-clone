...
<div
	class="w-[100vw] mt-4 gap-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1fr_1fr] grid-rows-[repeat(4,1fr)] place-items-center mx-2 md:mx-6 my-8 lg:mx-16 pb-4 "
>
