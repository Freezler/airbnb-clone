...
<div
	class="   md:grid-rows-[1fr_1fr_1fr] min-w-[250px] w-full max-w-[800px] border-[1px] border-gray-400 rounded-t-2xl rounded-b-2xl h-[460px] place-self-center grid shadow-lg"
>

	<img
		class=" object-cover h-40  rounded-t-2xl min-w-[250px] w-[100%] md:w-[80%] max-w-[800px] "
		src={rentalObject.images[0]}
		alt={rentalObject.name}
	/>
	<div class="p-6 grid grid-rows-sub grid-cols-1 grid-rows-2 grid-flow-row w-[35ch]">
